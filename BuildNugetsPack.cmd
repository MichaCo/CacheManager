...
.nuget\nuget.exe pack src\CacheManager.Core\CacheManager.Core.csproj -o D:\_Nuget -Prop Configuration=Release -verbosity detailed 
.nuget\nuget.exe pack src\CacheManager.SystemRuntimeCaching\CacheManager.SystemRuntimeCaching.csproj -o D:\_Nuget -Prop Configuration=Release -verbosity detailed 
.nuget\nuget.exe pack src\CacheManager.WindowsAzureCaching\CacheManager.WindowsAzureCaching.csproj -o D:\_Nuget -Prop Configuration=Release -verbosity detailed 
.nuget\nuget.exe pack src\CacheManager.Web\CacheManager.Web.csproj -o D:\_Nuget -Prop Configuration=Release -verbosity detailed 
