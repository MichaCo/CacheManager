...
namespace CacheManager.Core
{
    ...
    /// <para>
    /// For each supported cache system, there will be one implementation of this interface.
    /// </para>
    /// <para>
    /// The cache manager implementation in core assumes that every cache handle actually extends <see cref="BaseCacheHandle{TCacheValue}"/>
    /// and does not implement this interface directly.
    /// </para>
    /// </summary>
