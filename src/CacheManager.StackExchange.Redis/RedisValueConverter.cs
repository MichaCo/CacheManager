...
namespace CacheManager.Redis
{
        ...
        IRedisValueConverter<object>
    {
        ...
        RedisValue IRedisValueConverter<byte>.ToRedisValue(byte value) => (uint)value;

        byte IRedisValueConverter<byte>.FromRedisValue(RedisValue value, string valueType) => (byte)(uint)value;
        ...
        RedisValue IRedisValueConverter<ushort>.ToRedisValue(ushort value) => (uint)value;

        ushort IRedisValueConverter<ushort>.FromRedisValue(RedisValue value, string valueType) => (ushort)(uint)value;
